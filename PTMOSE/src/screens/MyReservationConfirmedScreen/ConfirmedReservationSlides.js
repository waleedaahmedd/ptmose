...
const ListItem = ({ item }) => {
  ...
  const onPressMyReservationSliderEliments = () => {
    navigation.navigate('EventsDetailsScreen');
    // console.warn('onPressMyReservationSliderEliments');
  };
  ...
  return (
    ...
    <Pressable onPress={onPressMyReservationSliderEliments} >
    ...
    <View style={styles.containers}>
      ...
      <View style={styles.eventInfoPort}>
        <View><Text style={{fontSize: 12, fontFamily: 'Inter-Bold', color: '#3F0321',marginRight: 150, marginTop: 10}}>{item.marchant}</Text></View>
