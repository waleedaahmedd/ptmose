...
const ListItem = ({ item }) => {
  ...
  const onPressWineriesListSliderEliments = () => {
    navigation.navigate('WineryDetailsScreen');
    // console.warn('onPressWineriesListSliderEliments');
  }; 

  return (

    <Pressable onPress={onPressWineriesListSliderEliments}>
    ...
    <View style={styles.containers}>
      ...
      <View style={styles.eventInfoPort}>
        ...
        <View><Text style={{fontSize: 18, fontFamily: 'MontaguSlab_120pt-Regular', color: '#CDA15C', marginRight: 170,}}>{item.marchant}</Text></View>
        <View><Text style={{fontSize: 14, fontFamily: 'Inter-Regular', color: '#777080',marginRight: 150, marginTop: 10}}>{item.description}</Text></View>
