...
import UnConfirmedReservationSlides from './UnConfirmedReservationSlides';
...
const MyReservationUnconfirmedScreen = () => {
  ...
  return (
    ...
    <View style={styles.body}>
      ...
      <Text style={{marginLeft: 20,marginTop: 20, fontSize: 15, color: '#3F0321', fontFamily: 'Inter-Bold',}} >UNCONFIRMED</Text>

      <View style={{flex: 0.6}}>
        <UnConfirmedReservationSlides/>
      </View>
...
export default MyReservationUnconfirmedScreen;
